<?php
$current_user = $da->getCurrentUser();
?>

<h3 class="da-title">Personal information</h3>

<div class="da-inner-content da-info">
    ...
    <form id="da-edit-user" method="POST">
        ...
        <div class="da-row">
            ...
            <input type="email" name="account_email" id="account_email" value="<?php echo $current_user->user_email; ?>" />
        </div>
        ...
        <div class="da-row">
            <label for="partner_state">State / Province</label>
        ...
        <div class="da-row da-text-right">
            <input type="submit" value="Save" class="da-button" />
        </div>
    </form>

    <script>
        jQuery(document).ready(function ($) {
            $('#partner_country option[value="<?php echo get_user_meta($current_user->ID, 'partner_country', true); ?>"]').attr("selected", "selected");

            if ($('#partner_country option:selected').val() == 'US') {
                $('#partner_state option[value="<?php echo get_user_meta($current_user->ID, 'partner_state', true); ?>"]').attr("selected", "selected");
            }
            else {
            ...
            $('#partner_country').on("change", function () {
                if ($('option:selected', this).val() == 'US') {
                    ...
                    $('#partner_state option:first-child').attr('selected', 'selected');
                    $('#partner_state').attr('disabled', 'disabled');
                }
            });
        });
